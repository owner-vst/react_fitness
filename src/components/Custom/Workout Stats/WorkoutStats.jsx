                    ...
                    <div className="card-body">
                      <div className="d-flex mb-sm-5 mb-3">
                        <div className="d-inline-block relative donut-chart-sale me-3">
                          <span
                            className="donut"
                            data-peity='{ "fill": ["rgb(255, 148, 50)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'
                          >
                            2/8
                          </span>
                          <small>
                      ...
                      <div className="d-flex mb-sm-5 mb-3">
                        <div className="d-inline-block relative donut-chart-sale me-3">
                          <span
                            className="donut"
                            data-peity='{ "fill": ["rgb(30, 167, 197)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'
                          >
                            6/8
                          </span>
                          <small>
                      ...
                      <div className="d-flex">
                        <div className="d-inline-block relative donut-chart-sale me-3">
                          <span
                            className="donut"
                            data-peity='{ "fill": ["rgb(192, 70, 211)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'
                          >
                            2/8
                          </span>
                          <small>
