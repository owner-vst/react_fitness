          ...
          <div className="col-xl-3 col-md-4 col-sm-6">
            <div className="card ">
              <div className="card-body p-4">
                ...
                <h2 className="fs-24 text-black font-w600 mb-0">
                  ${vendorDashboardStats.totalSales._sum.total_price}
                </h2>
          ...
          <div className="col-xl-3 col-md-4 col-sm-6">
            <div className="card ">
              <div className="card-body p-4">
                ...
                <h2 className="fs-24 text-black font-w600 mb-0">
                  {vendorDashboardStats.totalSalesCount}
                </h2>
          ...
          <div className="col-xl-3 col-md-4 col-sm-6">
            <div className="card">
              <div className="card-body p-4">
                ...
                <h2 className="fs-24 text-black font-w600 mb-0">
                  {vendorDashboardStats.weeklyProgress._sum.calories_burned.toFixed(
                    2
                  )}
                </h2>
          ...
          <div className="col-xl col-md-4 col-sm-6">
            <div className="card">
              <div className="card-body p-4">
                ...
                <h2 className="fs-24 text-black font-w600 mb-0">
                  {vendorDashboardStats.totalCaloriesBurnedUser._sum.calories_burned.toFixed(
                    2
                  )}
                </h2>
